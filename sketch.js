...
fill(0);
textSize(28);
text("Ache o but! (☠️)", width / 2, 40);
// Primeiro desenha só o Wally (por trás)
text("☠️ ", posicoes[wallyIndex].x, posicoes[wallyIndex].y);
// Depois desenha todos as árvores
...
if (d < 20) {
if (i === wallyIndex) {
mensagem = "🎉 Você encontrou o but!";
noLoop(); // opcional: parar o jogo após acerto
} else {
mensagem = "❌ Ops! Esse não é o but.";
}
break;
}
}
